  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Acesse sua conta no Portal AUDITORIA360" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet" />
      </Head>
      
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 px-4 overflow-hidden relative font-sans">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end">
                <Link 
                  ...
                  className="text-sm text-blue-300 hover:text-white font-medium transition-colors duration-200 hover:underline"
                >
                  Esqueceu a senha?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-3 px-6 rounded-xl font-bold text-gray-900 transition-all duration-300 transform hover:scale-105 ${
                  loading 
                    ? 'bg-gray-400 cursor-not-allowed' 
                    : 'bg-yellow-400 hover:bg-yellow-300 hover:shadow-lg hover:shadow-yellow-400/25'
                }`}
              >
                {loading ? (
