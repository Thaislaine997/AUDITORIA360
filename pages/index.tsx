...
const HomePage: NextPage = () => {
  return (
    <>
      <Head>
        <title>
          AUDITORIA360 - Plataforma Moderna de Terceirização de Departamento
          Pessoal
        </title>
        <meta
          name="description"
          content="AUDITORIA360 - Soluções modernas em Departamento Pessoal e Recursos Humanos"
        />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
              <div className="text-center">
                ...
                <p className="text-lg mb-10 max-w-3xl mx-auto text-blue-50">
                  Soluções completas em Departamento Pessoal e Recursos Humanos
                  para contabilidades e empresas que buscam precisão, eficiência
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Tecnologia de ponta para processos 100% digitais e compliance
                  garantido
                </p>
              </div>
          ...
          <section className="bg-gray-50 py-20">
            <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Acesse nossa plataforma e descubra como podemos transformar seus
                processos
              </p>
              <Link
                href="/login"
