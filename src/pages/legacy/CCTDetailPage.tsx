...
import { useCCTs } from '../../frontend/lib/hooks/usePortalDemandasDomain';
import { IAAnalysisButton } from '../../frontend/components/IAAnalysisButton';
import { useIASuggestionStore } from '../../frontend/stores/iaSuggestionStore';
	...
	return (
		<Box maxWidth={700} mx="auto" mt={4}>
			<Breadcrumbs aria-label="breadcrumb" sx={{ mb: 2 }}>
				<Link href="/dashboard" style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center' }}><Home fontSize="small" /> Dashboard</Link>
