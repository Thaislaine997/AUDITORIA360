...
import { dashboardService, type DashboardMetric } from "../frontend/src/modules/dashboard/dashboardService";
import { usePredictiveLoading, useAdaptiveUI } from "../frontend/src/hooks/useNeuralSignals";
import { useIntentionStore } from "../frontend/src/stores/intentionStore";
import ROICognitivoWidget from "../frontend/src/components/ui/ROICognitivoWidget";
