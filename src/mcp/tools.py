...
class AuditoriaToolProvider:
    ...
    def _register_tools(self):
        ...
        self.server.register_tool(payroll_calculator.name, payroll_calculator, self._execute_payroll_calculator)
        ...
        compliance_checker = ToolInfo(
            ...
            inputSchema={
                ...
                "properties": {
                    "employee_id": {"type": "string", "description": "Employee identifier"},
                    "payroll_data": {"type": "object", "description": "Payroll data to check"},
                    "cct_id": {"type": "string", "description": "CCT identifier to check against"},
                    "check_type": {
                        "type": "string",
                        "enum": ["full", "salary", "benefits", "working_hours", "termination"],
        ...
        self.server.register_tool(compliance_checker.name, compliance_checker, self._execute_compliance_checker)
        ...
        document_analyzer = ToolInfo(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "compare_with": {"type": "string", "description": "Document ID to compare with (for comparison analysis)"}
                },
        ...
        self.server.register_tool(document_analyzer.name, document_analyzer, self._execute_document_analyzer)
        ...
        audit_executor = ToolInfo(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "period_start": {"type": "string", "format": "date", "description": "Audit period start date"},
                    "period_end": {"type": "string", "format": "date", "description": "Audit period end date"},
                    "departments": {"type": "array", "items": {"type": "string"}, "description": "Departments to audit"},
                    "specific_rules": {"type": "array", "items": {"type": "string"}, "description": "Specific rules to check"}
                },
        ...
        self.server.register_tool(audit_executor.name, audit_executor, self._execute_audit_executor)
        ...
        cct_comparator = ToolInfo(
            ...
            inputSchema={
                "type": "object",
                "properties": {
                    "cct_id_1": {"type": "string", "description": "First CCT identifier"},
                    "cct_id_2": {"type": "string", "description": "Second CCT identifier"},
                    "comparison_type": {
                        "type": "string",
                        "enum": ["full", "salary_clauses", "benefit_clauses", "working_conditions", "termination_clauses"],
                        "description": "Type of comparison to perform"
                    },
                    "highlight_differences": {"type": "boolean", "default": True, "description": "Whether to highlight differences"},
                    "include_recommendations": {"type": "boolean", "default": False, "description": "Include implementation recommendations"}
                },
        ...
        self.server.register_tool(cct_comparator.name, cct_comparator, self._execute_cct_comparator)
    
    async def _execute_payroll_calculator(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            overtime_pay = Decimal(str(overtime_hours)) * (base_salary / Decimal("160")) * Decimal("1.5")
            gross_salary = base_salary + overtime_pay
            
            inss_deduction = gross_salary * inss_rate
            taxable_income = gross_salary - inss_deduction
            irrf_deduction = max(Decimal("0"), taxable_income * irrf_rate - Decimal("142.80"))  # Basic deduction
    ...
    async def _execute_compliance_checker(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if check_type == "salary":
                ...
                if salary < min_wage:
                    ...
                    recommendations.append("Adjust salary to meet minimum wage requirements")
    ...
    async def _execute_document_analyzer(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _execute_audit_executor(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _execute_cct_comparator(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
