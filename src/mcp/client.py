...
class MCPClient:
    ...
    async def read_resource(self, uri: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.error:
                raise Exception(f"Failed to read resource {uri}: {response.error.message}")
...
class MCPClientManager:
    ...
    def register_client(self, name: str, client: MCPClient, config: Dict[str, Any] = None):
    ...
    async def call_tool_on_client(self, client_name: str, tool_name: str, arguments: Dict[str, Any] = None) -> Dict[str, Any]:
...
async def create_simple_mcp_client(server_handler: Callable, name: str = "AUDITORIA360-Client") -> MCPClient:
