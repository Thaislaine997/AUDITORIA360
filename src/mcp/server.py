...
from .protocol import (
    MCPRequest, MCPResponse, MCPNotification, MCPError, ErrorCode,
    InitializeRequest, InitializeResponse, ServerInfo,
    ListResourcesRequest, ListResourcesResponse, ResourceInfo,
    ReadResourceRequest, ReadResourceResponse,
    ListToolsRequest, ListToolsResponse, ToolInfo,
    CallToolRequest, CallToolResponse,
    ResourceUpdateNotification, ToolUpdateNotification
)
...
class AuditoriaResourceProvider:
    ...
    def _register_resources(self):
        ...
        self.server.register_resource(payroll_resource.uri, payroll_resource, self._read_payroll_data)
        ...
        self.server.register_resource(employee_resource.uri, employee_resource, self._read_employee_info)
        ...
        self.server.register_resource(cct_resource.uri, cct_resource, self._read_cct_documents)
        ...
        self.server.register_resource(compliance_resource.uri, compliance_resource, self._read_compliance_rules)
        ...
        self.server.register_resource(kb_resource.uri, kb_resource, self._read_knowledge_base)
