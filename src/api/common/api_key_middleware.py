...
class RateLimiter:
    ...
    def is_allowed(self, key: str, limit: int = 1000, window: int = 3600) -> Tuple[bool, Dict[str, Any]]:
        """
...
def log_api_request(api_key: str, request: Request, response_time: float, status_code: int):
    """
...
async def verify_api_key(credentials: HTTPAuthorizationCredentials = security) -> Dict[str, Any]:
    """
