...
try:
    ...
    from src.models import AccessLog, Permission, User, get_db
...
try:
    ...
    from src.schemas.auth_schemas import Permission as PermissionSchema
    from src.schemas.auth_schemas import (
        PermissionCreate,
        Token,
    )
...
async def login(login_data: LoginRequest, db: Session = Depends(get_db)):
    ...
    # Try unified auth first if available
