...
async def get_performance_dashboard(
    ...
    performance_metrics = {
        "response_times": {"p50": 150, "p95": 300, "p99": 500},  # milliseconds
        "throughput": {"requests_per_second": 85, "requests_per_minute": 5100},
        "database": {
...
async def quick_performance_benchmark(
    ...
    return {
        ...
        "status": (
            "excellent"
            if overall_score > 80
            else "good" if overall_score > 60 else "needs_optimization"
        ),
        "timestamp": time.time(),
    }
