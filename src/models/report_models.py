...
class ReportTemplate(Base):
    ...
    )  # For sharing within organization
    ...
    blocks = relationship(
        "ReportBlock", back_populates="template", cascade="all, delete-orphan"
    )
...
class GeneratedReport(Base):
    ...
    generated_for_client_id = Column(
        Integer, ForeignKey("users.id")
    )  # Client the report was generated for
