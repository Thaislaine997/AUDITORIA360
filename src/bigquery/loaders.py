...
class ControleFolhaLoader(BaseLoader):
        ...
        **kwargs,
        ...
        try:
            ...
            data = {
                ...
                "empresa_id": self.client_id
                or cnpj,  # Use client_id or fallback to CNPJ
            }
            ...
            success = self.data_operations.insert_rows(
                self.dataset_id, self.table_id, [data]
            )
    ...
    def atualizar_status_folha(self, registro_id: str, novo_status: str) -> bool:
        ...
        try:
            ...
            return self.data_operations.update_rows(
                self.dataset_id, self.table_id, update_query, query_parameters
            )
    ...
    def get_empresa_by_cnpj(self, cnpj: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            query_parameters = [bigquery.ScalarQueryParameter("cnpj", "STRING", cnpj)]
    ...
    def get_payroll_summary(
        ...
        try:
            ...
            if self.client_id:
                ...
                parameters.append(
                    bigquery.ScalarQueryParameter(
                        "empresa_id", "STRING", self.client_id
                    )
                )
...
class EmployeeLoader(BaseLoader):
    ...
    def _create_tables(self) -> bool:
        ...
        return self.schema_manager.create_table_if_not_exists(
            self.dataset_id, self.table_id, schema, "Employee data for AUDITORIA360"
        )
