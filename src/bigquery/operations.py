...
class DataOperations:
    ...
    def _validate_identifier(
        ...
        if not re.match(
            ...
            raise ValueError(
                f"Invalid {identifier_type}: {identifier}. Only alphanumeric, underscore, and dot allowed."
            )
        return True
    ...
    def insert_rows(
        ...
        try:
            ...
            errors = self.client.insert_rows_json(
                table, rows, ignore_unknown_values=ignore_unknown_values
            )
    ...
    def load_data_from_file(
        ...
        try:
            ...
            logger.info(
                f"Successfully loaded data from {source_file_path} into {table_id}"
            )
            return True
    ...
    def backup_table(
        ...
        try:
            ...
            source_table_ref = (
                f"{self.client.project}.{source_dataset_id}.{source_table_id}"
            )
            backup_table_ref = (
                f"{self.client.project}.{backup_dataset_id}.{backup_table_id}"
            )
            ...
            logger.info(
                f"Successfully backed up {source_table_id} to {backup_table_id}"
            )
            return True
