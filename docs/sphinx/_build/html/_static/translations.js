Documentation.addTranslations({
  ...
  messages: {
    ...
    "Automatically generated list of changes in version %(version)s":
      "Lista de altera\u00e7\u00f5es na vers\u00e3o %(version)s, gerada automaticamente",
    "C API changes": "Altera\u00e7\u00f5es na API C",
    "Changes in Version %(version)s &#8212; %(docstitle)s":
      "Modifica\u00e7\u00f5es na vers\u00e3o %(version)s &#8212; %(docstitle)s",
    "Collapse sidebar": "Recolher painel lateral",
    "Complete Table of Contents": "Tabela Completa dos Conte\u00fados",
    Contents: "Conte\u00fados",
    Copyright: "Copyright",
    'Created using <a href="https://www.sphinx-doc.org/">Sphinx</a> %(sphinx_version)s.':
      'Criada usando <a href="https://www.sphinx-doc.org/pt_BR/master">Sphinx</a> %(sphinx_version)s.',
    ...
    "Last updated on %(last_updated)s.":
      "\u00daltima atualiza\u00e7\u00e3o em %(last_updated)s.",
    ...
    "Searching for multiple words only shows matches that contain\n    all words.":
      "Pesquisando por v\u00e1rias palavras s\u00f3 mostra correspond\u00eancias\nque cont\u00eam todas as palavras.",
    ...
    "Your search did not match any documents. Please make sure that all words are spelled correctly and that you've selected enough categories.":
      "Sua busca n\u00e3o encontrou nenhum documento. Por favor, confirme se todas as palavras est\u00e3o grafadas corretamente e se voc\u00ea selecionou categorias suficientes.",
    "all functions, classes, terms": "todas fun\u00e7\u00f5es, classes, termos",
    "can be huge": "pode ser enorme",
    "last updated": "\u00faltima atualiza\u00e7\u00e3o",
    "lists all sections and subsections":
      "Listar todas se\u00e7\u00f5es e subse\u00e7\u00f5es",
