...
if __name__ == "__main__":
    try:
        if len(sys.argv) > 1:
            ...
            password = input(
                "Digite uma senha forte para criptografar os arquivos da pasta configs: "
            )
        ...
        for fname in os.listdir(CONFIGS_DIR):
            ...
            if (
                ...
                and not fname.endswith(".key")
                and not fname.endswith(".enc")
            ):
                try:
        ...
        print(
            "Arquivos criptografados com sucesso! Guarde a senha e o arquivo configs.key para descriptografar."
        )
    except Exception as e:
