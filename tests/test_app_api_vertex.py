...
def test_prever_rubrica_payload_invalido():
    ...
    """
    response = client.post("/prever-rubrica/", json={"conteudo": "Isso está errado"}) # Campo incorreto
...
def test_prever_rubrica_payload_texto_nao_string():
    ...
    Espera-se um erro 422 do FastAPI.
    """
    response = client.post("/prever-rubrica/", json={"texto": 12345}) # 'texto' não é string
