...
def test_listar_ccts_parametrizado(
    monkeypatch, mock_return, params, expected_len, expected_status, expected_first_id
):
    async def mock_listar_ccts(
        id_cliente_afetado=None, sindicato_nome_contem=None, data_vigencia_em=None
    ):
        return mock_return
