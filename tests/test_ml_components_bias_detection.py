...
class TestBiasDetection:
    ...
    def test_detect_bias_returns_dict(self):
        ...
        result = detect_bias(
            self.mock_model, self.data, target_col="target", group_col="group"
        )
    ...
    def test_detect_bias_without_group_col_returns_error(self):
        ...
        result = detect_bias(
            self.mock_model, self.data, target_col="target", group_col=None
        )
    ...
    def test_detect_bias_with_perfect_predictions(self):
        ...
        result = detect_bias(
            perfect_model, self.data, target_col="target", group_col="group"
        )
    ...
    def test_detect_bias_with_random_predictions(self):
        ...
        result = detect_bias(
            random_model, self.data, target_col="target", group_col="group"
        )
    ...
    def test_detect_bias_model_called_correctly(self):
        ...
        detect_bias(self.mock_model, self.data, target_col="target", group_col="group")
    ...
    def test_detect_bias_with_single_group(self):
        ...
        result = detect_bias(
            self.mock_model, single_group_data, target_col="target", group_col="group"
        )
    ...
    def test_detect_bias_with_empty_groups(self):
        ...
        empty_data = pd.DataFrame(
            {"feature1": [], "feature2": [], "group": [], "target": []}
        )

        result = detect_bias(
            self.mock_model, empty_data, target_col="target", group_col="group"
        )
    ...
    def test_detect_bias_with_different_target_col(self):
        ...
        result = detect_bias(
            self.mock_model, data_custom, target_col="custom_target", group_col="group"
        )
    ...
    def test_detect_bias_with_numeric_groups(self):
        ...
        result = detect_bias(
            self.mock_model, numeric_data, target_col="target", group_col="group"
        )
    ...
    def test_detect_bias_handles_model_exceptions(self):
        ...
        with pytest.raises(Exception):
            detect_bias(
                failing_model, self.data, target_col="target", group_col="group"
            )
