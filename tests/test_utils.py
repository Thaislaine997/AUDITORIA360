...
def test_config_manager_import():
    ...
    try:
        from services.core.config_manager import load_config, get_setting
...
def test_frontend_utils_import():
    ...
    from src.frontend.utils import (
        get_auth_headers, is_authenticated, require_authentication,
        get_current_user, logout_user, make_authenticated_request
    )
