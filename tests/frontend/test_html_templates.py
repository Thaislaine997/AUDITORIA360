...
class TestHTMLTemplates:
    ...
    def test_navigation_template_structure(self):
        ...
        assert 'main-navigation' in nav.get('class', []), "Nav deve ter classe main-navigation"
    ...
    def test_navigation_template_handlebars_syntax(self):
        ...
        assert "{{#if navigationTitle}}" in content, "Template deve usar condicional para título"
        assert "{{#if navigationItems}}" in content, "Template deve usar condicional para itens"
        assert "{{#each navigationItems}}" in content, "Template deve usar loop para itens"
