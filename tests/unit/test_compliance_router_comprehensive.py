...
class TestAuditRouter:
    ...
    def test_execute_audit_success_admin(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_execute_audit_success_contador(self, mock_get_db, mock_get_current_user, client, mock_db, mock_contador_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_execute_audit_forbidden_regular_user(self, mock_get_db, mock_get_current_user, client, mock_db, mock_regular_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_executions_success(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_executions_with_pagination(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_executions_contador_access(self, mock_get_db, mock_get_current_user, client, mock_db, mock_contador_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_executions_regular_user_access(self, mock_get_db, mock_get_current_user, client, mock_db, mock_regular_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_findings_success(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_findings_with_filters(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
        """Test list_audit_findings with severity and resolved filters"""
        mock_get_current_user.return_value = mock_admin_user
        mock_get_db.return_value = mock_db
        
        response = client.get("/audit/findings?severity=high&resolved=false&skip=5&limit=25")
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_findings_severity_filter_only(self, mock_get_db, mock_get_current_user, client, mock_db, mock_contador_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_findings_resolved_filter_only(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_audit_findings_invalid_bool_parameter(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_create_compliance_rule_success_admin(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_create_compliance_rule_forbidden_contador(self, mock_get_db, mock_get_current_user, client, mock_db, mock_contador_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_create_compliance_rule_forbidden_regular_user(self, mock_get_db, mock_get_current_user, client, mock_db, mock_regular_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    def test_create_compliance_rule_authentication_required(self, mock_get_current_user, client):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_compliance_reports_success(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_compliance_reports_contador_access(self, mock_get_db, mock_get_current_user, client, mock_db, mock_contador_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_list_compliance_reports_regular_user_access(self, mock_get_db, mock_get_current_user, client, mock_db, mock_regular_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_endpoints_with_database_error(self, mock_get_db, mock_get_current_user, client, mock_admin_user):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_execute_audit_with_malformed_user(self, mock_get_db, mock_get_current_user, client, mock_db):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_create_compliance_rule_with_malformed_user(self, mock_get_db, mock_get_current_user, client, mock_db):
    ...
    def test_list_audit_executions_negative_skip(self, client):
        ...
        with patch('src.api.routers.audit.get_current_user') as mock_user, \
             patch('src.api.routers.audit.get_db') as mock_db:
    ...
    @pytest.mark.parametrize("user_role", [
        "administrador", "contador", "usuario", "guest", "manager"
    ])
    ...
    def test_create_compliance_rule_role_matrix(self, client, user_role, expected_status):
    ...
    @patch('src.api.routers.audit.get_current_user')
    @patch('src.api.routers.audit.get_db')
    def test_concurrent_audit_execution_requests(self, mock_get_db, mock_get_current_user, client, mock_db, mock_admin_user):
