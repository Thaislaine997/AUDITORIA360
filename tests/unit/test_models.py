...
from src.models import (
    User, Permission, AccessLog, Employee, PayrollCompetency, 
    Document, CCT, Notification, AuditExecution, KnowledgeBase,
    Base, get_db, init_db, create_all_tables
)
...
def test_audit_execution_model_creation():
    ...
    audit = AuditExecution(
        audit_name="Monthly Payroll Audit",
        executed_by=1,
        status="completed"
    )
...
def test_model_inheritance():
    ...
    models = [User, Permission, Employee, Document, CCT, Notification, AuditExecution, KnowledgeBase]
