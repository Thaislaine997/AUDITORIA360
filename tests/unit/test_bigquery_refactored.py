...
from src.bigquery.loaders import ControleFolhaLoader
...
class TestControleFolhaLoader:
    ...
    @patch("src.bigquery.loaders.SchemaManager")
    @patch("src.bigquery.loaders.DataOperations")
    def test_listar_todas_as_empresas(
        self, mock_operations, mock_schema, mock_client_class
    ):
...
class TestBackwardCompatibility:
    ...
    def test_ensure_dataset_exists_legacy(self, mock_schema_manager):
        ...
        mock_manager.create_dataset_if_not_exists.assert_called_once_with(
            "test_dataset", "US"
        )
