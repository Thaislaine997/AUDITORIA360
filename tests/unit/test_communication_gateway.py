...
class TestEmailProvider:
    ...
    def test_email_provider_invalid_message_type(self):
        ...
        with pytest.raises(
            ValueError, match="EmailProvider only supports EMAIL messages"
        ):
...
class TestTwilioProvider:
    ...
    def test_twilio_provider_send_sms_success(self):
        ...
        mock_client.messages.create.assert_called_once_with(
            body="Test SMS message", from_="+15551234567", to="+5511999999999"
        )
    ...
    def test_twilio_provider_invalid_message_type(self):
        ...
        with pytest.raises(
            ValueError, match="TwilioProvider only supports SMS and WhatsApp"
        ):
            provider.send_message(
                to="+5511999999999",
                message="Test message",
