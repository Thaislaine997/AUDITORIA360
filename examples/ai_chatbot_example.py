...
class ChatbotAPI:
    ...
    def analyze_document(
        self, document_id: int, analysis_type: str = "general"
    ) -> Dict:
        """
...
def example_document_analysis():
    ...
    for scenario in analysis_scenarios:
        ...
        result = api.analyze_document(
            document_id=scenario["document_id"], analysis_type=scenario["analysis_type"]
        )
        ...
        if "analysis_result" in result:
            ...
            print(
                f"📊 Score de conformidade: {analysis.get('compliance_score', 0):.1f}/10"
            )
