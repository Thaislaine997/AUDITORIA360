    ...
    try:
        ...
        for test_key, test_name in test_names.items():
            if test_key in results['individual_tests']:
                ...
                status = '✅ PASSOU' if test_result.get('test_passed', False) else '❌ FALHOU'
        ...
        if results['all_tests_passed']:
            ...
            print(f"🔧 {results['tests_passed']}/{results['total_tests']} testes passaram")
        ...
        print(f"   🎓 Especializações: {len(collective_state['specializations_available'])}")
        ...
        if collective_state['specializations_available']:
            ...
            for spec in collective_state['specializations_available'][:5]:  # Show first 5
                print(f"      • {spec}")
