...
Este script orquestra o processo completo de rastreamento cinético:
1. Inicia o ambiente Docker com Jaeger
2. Executa testes E2E instrumentados
3. Consulta a API do Jaeger para extrair traços
            ...
            for test_file in test_files:
                if Path(test_file).exists():
                    ...
                    if result.returncode != 0:
                        ...
                        print(f"✅ Teste passou: {test_file}")
                else:
...
<head>
    ...
    <title>ACR - Relatório de Rastreamento Cinético</title>
    <style>
        :root {{
...
<body>
    <div class="container">
        ...
        if diagram_path and Path(diagram_path).exists():
            html_content += f"""
        <div class="diagram">
            <h2>🎨 Diagrama de Fluxo Cinético</h2>
        ...
        <div class="service-card">
            ...
            <p>Duração Média: {avg_duration:.1f}ms</p>
        ...
        <footer style="text-align: center; margin-top: 40px; padding: 20px; color: #6B7280;">
            <p>Gerado pelo ACR - Agente de Rastreamento Cinético | Auditoria360 | Grande Síntese</p>
        </footer>
    </div>
</body>
</html>
...
Opções:
  ...
  --jaeger-url     URL do Jaeger (padrão: http://localhost:16686)
  --hours-back     Horas para buscar traces (padrão: 1)
