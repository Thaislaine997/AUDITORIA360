...
from src.controllers.dashboard_folha_controller import DashboardSaudeFolhaResponse, get_saude_folha_data_controller
...
async def get_dashboard_saude_folha(
    ...
    dashboard_data = await get_saude_folha_data_controller(
