    ...
    def send_notification(
        ...
        **kwargs
        ...
        try:
            ...
            message_type = self._map_notification_type_to_message_type(notification_type)
    ...
    def _send_auto_response(
        ...
        try:
            ...
            if from_number and response_message:
                message_type = MessageType.WHATSAPP if message_type_str == "whatsapp" else MessageType.SMS
