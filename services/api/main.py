...
# Importar todos os outros roteadores necessários
try:
    from . import (
        auth_routes,
    ...
    print(f"Warning: Some route modules not available: {e}")
...
if ROUTERS_AVAILABLE:
    ...
    print("Warning: Router modules not available, running with limited functionality")
