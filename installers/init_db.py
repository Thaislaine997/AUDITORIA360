...
def create_database_tables():
    ...
    try:
        ...
        from src.models.auth_models import User, Role, UserRole
        from src.models.payroll_models import Employee, PayrollRecord
        from src.models.document_models import Document, DocumentVersion
        from src.models.cct_models import CCT, CCTClause
        from src.models.audit_models import AuditLog, ComplianceRule
        from src.models.notification_models import Notification, NotificationTemplate
        from portal_demandas.db import TicketDB, Base as PortalBase
